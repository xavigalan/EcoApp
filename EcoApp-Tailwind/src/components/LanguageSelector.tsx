...
const LanguageSelector: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        className={`flex items-center space-x-1 text-white p-2 rounded-md text-sm font-medium ${
      ...
      <div
        ...
        } z-10`} // Add z-10 to ensure dropdown appears above other elements
      >
          ...
          {languages.map((lang) => (
            <button
              ...
              className={`block px-4 py-2 text-sm w-full text-left ${
                i18n.language === lang.code ? 'bg-green-50 text-green-800' : 'text-gray-700'
              } hover:bg-green-100`}
              role="menuitem"
            >
              {lang.name}
